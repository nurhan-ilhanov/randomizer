...
namespace Randomizer.Web.Data.Migrations
{
    ...
    [Migration("20161111131856_AddUserID_ToElementListsTable")]
    partial class AddUserID_ToElementListsTable
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Randomizer.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Randomizer.Model.ApplicationUser")
                        .WithMany("Claims")
